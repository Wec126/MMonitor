...
def prepare_config():
    config_mmonitor_resnet18 = {
        nn.BatchNorm: ['BackwardOutputMean','BackwardOutputNorm','BackwardOutputStd']
        # nn.BatchNorm: ['ForwardInputCovCondition','ForwardInputCovCondition20','ForwardInputCovCondition80','ForwardInputCovCondition50']
    }
