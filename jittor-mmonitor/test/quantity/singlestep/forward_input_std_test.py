...
def test_linear():
    ...
    print(if_similar(quantity.get_output()[0],jt.std(x_linear)))
...
def test_conv():
    ...
    quantity.track(i)
    print(quantity.get_output()[0])
    print(if_similar(quantity.get_output()[0],jt.std(x_conv)))
def test_default():
    ...
    quantity.track(i)
    print(quantity.get_output()[0])
    print(if_similar(quantity.get_output()[0],jt.std(x_default)))
test_linear()
test_conv()
test_default()