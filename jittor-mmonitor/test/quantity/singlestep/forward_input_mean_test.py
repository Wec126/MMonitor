...
def test_linear():
    ...
    optimizer.step(loss)
    quantity.track(i)
    print(if_similar(quantity.get_output()[0],x_linear.mean()))
...
def test_conv():
    ...
    optimizer.step(loss)
    quantity.track(i)
    print(if_similar(quantity.get_output()[0],x_conv.mean()))
def test_default():
    ...
    optimizer.step(loss)
    quantity.track(i)
    print(if_similar(quantity.get_output()[0],x_default.mean()))
test_linear()
test_conv()
test_default()