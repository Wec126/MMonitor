...
def test_linear():
    ...
    if_similar(quantity.get_output()[0],jt.norm(jt.flatten(x_linear)))
...
def test_conv():
    ...
    quantity.track(i)
    print(quantity.get_output()[0])
    if_similar(quantity.get_output()[0],jt.norm(jt.flatten(x_conv)))
def test_default():
    ...
    quantity.track(i)
    print(quantity.get_output()[0])
    if_similar(quantity.get_output()[0],jt.norm(jt.flatten(x_default)))
test_linear()
test_conv()
test_default()